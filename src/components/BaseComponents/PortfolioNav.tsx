...
const PortfolioNav = ({ works, setWorks }: PortfolioNavProps) => {
	...
	return (
		<div className='fixed w-full bottom-8 max-md:bottom-4'>
			<div className='flex items-center justify-between mx-50 max-2xl:mx-20 max-xl:mx-10 max-lg:mx-8 bg-[#1c1b2e] light:bg-[#cacaca] backdrop-blur-xl p-2.5 rounded-full overflow-hidden'>
