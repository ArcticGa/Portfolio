	...
	return (
		<div className='relative'>
			...
			>
				...
				<div className='flex justify-center max-sm:pointer-events-none max-sm:select-none'>
					<div className='flex justify-center items-center w-130 h-130 border border-hr-info rounded-full max-md:w-80 max-md:h-80 max-sm:pointer-events-none max-sm:select-none'>
						<SceneAxolotl />
					</div>
				</div>
